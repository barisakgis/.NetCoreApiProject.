...
namespace Services
{
    ...
    {
        private readonly LinkGenerationDecisionTree _linkGenerationDecisionTree;

       // private readonly LinkGenerator  _linkGenerator;
        private readonly IDataShaper<BookDto> _dataShaper;

        public BookLinks(LinkGenerationDecisionTree linkGenerator,
            IDataShaper<BookDto> dataShaper)
        {
            _linkGenerationDecisionTree = linkGenerator;
        ...
        {
            return new LinkResponse() { ShapedEntity = shapedBooks };
        }
        ...
        public LinkResponse TrtGenerateLinks(IEnumerable<BookDto> books, string fields, HttpContext httpContext)
        {
